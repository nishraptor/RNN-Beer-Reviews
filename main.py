...
def pad_data(orig_data):
    ...
    print(np.repeat(char2oh('}'), max_len - orig_data[0].shape[0], axis=0))
    


    array_list = [np.append(array, np.repeat(char2oh('}'), max_len - array.shape[0], axis=0), axis=1) for array in orig_data]
