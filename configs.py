cfg = {}
cfg['input_dim'] = 3# input dimension to LSTM
cfg['hidden_dim'] = 4# hidden dimension for LSTM
cfg['output_dim'] = 1# output dimension of the model
cfg['layers'] = 3# number of layers of LSTM
...
cfg['learning_rate'] = .0001# learning rate to be used
